                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if($salesPages->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">No sales pages generated</h3>
                            <p class="mt-1 text-sm text-gray-500">Get started by creating a new AI-generated sales page.</p>
                            <div class="mt-6">
                                <a href="{{ route('sales-pages.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    ...
                                    @foreach($salesPages as $page)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">{{ $page->product_name }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-500">{{ $page->target_audience }}</div>
                                            </td>
